...
tmp_default_features = {
    "build_area_dimensions": {
        ...
        "bed_radius": (155, "int", 50, None, True, False),
...
tmp_features_dict = {
    ...
    "layer_height": {
        ...
        "z_layer_height_mm_min": (
            round(tmp_default_features["extruder"]["nozzle_diameter_mm_0"][0] * 0.10, 2),
            "float",
            0,
            100,
            True,
        ...
        "z_layer_height_mm_max": (
            round(tmp_default_features["extruder"]["nozzle_diameter_mm_0"][0] * 0.80, 2),
            "float",
            0,
            100,
            True,
        ...
        "bed_temp_degree_c_max": (120, "int", 60, 100, True, False),
        ...
        "chamber_temp_degree_c_max": (110, "int", 0, 100, True, True),
    },
    "printing_speeds": {
        ...
        "print_speed_mm_per_sec_max": (default_printing_speed * 3.5, "float", 0, 100, True, False),
        ...
        "perimeter_print_speed_mm_per_sec_max": (default_printing_speed * 2.8, "float", 0, 100, True, False),
        ...
        "cover_print_speed_mm_per_sec_max": (default_printing_speed * 2.8, "float", 0, 100, True, False),
        ...
        "first_layer_print_speed_mm_per_sec_max": (default_printing_speed * 2.8, "float", 0, 100, True, False),

    },"acceleration_settings": {
        "default_acc": (default_accel, "int", 0, 100, True, True),
        "e_prime_max_acc": (default_accel / 2, "float", 0, 100, True, True),
        "perimeter_acc": (default_accel / 2, "float", 0, 100, True, True),
        "infill_acc": (default_accel, "int", 0, 100, True, True),
        "x_max_acc": (default_accel, "int", 0, 100, True, True),
        "y_max_acc": (default_accel, "int", 0, 100, True, True),
        "z_max_acc": (default_accel / 40, "float", 0, 100, True, True),
        "e_max_acc": (default_accel, "int", 0, 100, True, True),
        "classic_jerk": (False, "bool", None, None, True, True),
        "default_jerk": (default_jerk, "int", 0, 100, True, True),
        "infill_jerk": (default_jerk, "int", 0, 100, True, True),
        "default_junction_deviation": (round(0.4 * (default_jerk**2 / default_accel), 4), "float", 0, 100, True, True),
        "perimeter_junction_deviation": (round(0.4 * (default_jerk**2 / default_accel), 4), "float", 0, 100, True, True),
        "infill_junction_deviation": (round(0.4 * (infill_jerk**2 / default_accel), 4), "float", 0, 100, True, True),
        "travel_junction_deviation": (round(0.4 * (default_jerk**2 / default_accel), 4), "float", 0, 100, True, True),
    },
...
tmp_materials_features = {
    "retraction_changes": {
        "filament_priming_mm": (0.8, "float", 0, 100, False, False),
    },
    "temperature_changes": {
        "extruder_temp_degree_c": (210, "int", 0, 100, False, False),
        "bed_temp_degree_c": (60, "int", 0, 100, False, False),
